...
//
export const validateTime = (time: any): boolean => {
...
// 12            December             31
//
export const validateDate = (datestring: any): boolean => {
...
// Where *s is a fraction of seconds with at least 1 digit.
//
export const validateDateTime = (dateTimeString: any): boolean => {
...
//
export const validateUnixTimestamp = (timestamp: any): boolean => {
