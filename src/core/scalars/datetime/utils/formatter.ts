...
export const parseTime = (time: any): Date => {
...
// it to UTC.
export const serializeTimeString = (time: any): string => {
...
export const parseDateTime = (dateTime: any): Date => {
...
// it to UTC.
export const serializeDateTimeString = (dateTime: any): string => {
	// If already formatted to UTC then return the time string
...
// in the format YYYY-MM-DDThh:mm:ss.sssZ
export const serializeUnixTimestamp = (timestamp: any): string => {
